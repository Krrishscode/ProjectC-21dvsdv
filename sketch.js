...
function setup() {
    ...
    noticeBox = createSprite(width / 5, height / 1.8, 400, 200)
...
if (mousePressedOver(enterancex) || keyDown("enter")) {
    ...
    strokeWeight(1)
    fill("black")
    text(" Introducing you  our \n fully keyboard controls \n for more information visit the \n source code and \n checkout guide.txt", width/ 13, height / 2.1)
}
